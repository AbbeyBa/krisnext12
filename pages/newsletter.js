    ...
    <div className="relative w-full px-5 py-6 mx-auto sm:py-12 md:py-16 md:px-10 max-w-7xl">
        ...
        <div className="flex grid h-auto grid-cols-12 gap-10 pb-10 mt-8 sm:mt-16">
            <div className="relative flex flex-col items-start justify-end h-full col-span-12 overflow-hidden rounded-xl group md:col-span-6 xl:col-span-4">
                ...
                <img className="object-cover w-full h-full rounded-lg sm:max-h-full" src="https://ngpzwhzdavpdovrvzium.supabase.co/storage/v1/object/public/krisdemoassets/KRISULLIS_SEPT_issue_2022.jpg"></img>
                </a>
        ...
        <div className="relative flex flex-col items-start justify-end h-full col-span-12 overflow-hidden rounded-xl group md:col-span-6 xl:col-span-4">
                ...
                <img className="object-cover w-full h-full rounded-lg sm:max-h-full" src="https://ngpzwhzdavpdovrvzium.supabase.co/storage/v1/object/public/krisdemoassets/Coverpage_oct_issue_2022.png"></img>
                </a>
